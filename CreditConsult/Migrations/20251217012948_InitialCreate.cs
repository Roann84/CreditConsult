...
namespace CreditConsult.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_credit_consult", x => x.id);
                });

            migrationBuilder.CreateIndex(
                name: "IX_credit_consult_numero_credito",
                table: "credit_consult",
                column: "numero_credito");

            migrationBuilder.CreateIndex(
                name: "IX_credit_consult_numero_nfse",
                table: "credit_consult",
                column: "numero_nfse");

            migrationBuilder.CreateIndex(
                name: "IX_credit_consult_tipo_credito",
                table: "credit_consult",
                column: "tipo_credito");
        }
